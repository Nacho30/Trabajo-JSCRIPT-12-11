...
var calificaciones=[60,70,75,80,90,100,100,10,35,96,45,70,65]
for (var i = 0; i < calificaciones.length; i++) 
    if (calificaciones[i] < 60) {
        ...
        console.log('Excelente %'+ calificaciones[i])
    }
...
// Solución: 
var precios=[10000,2000,300000,40000,500,60,70,8000,80,90,10000]
for (var i = 0; i < precios.length; i++)
    if (precios[i]< 200){
        console.log('Producto barato $'+ precios[i])
    }
   else if (precios[i] >= 200 && precios[i] <= 5000) {
